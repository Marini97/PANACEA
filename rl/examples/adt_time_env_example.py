...
def demo_environment(env_file):
    ...
    env = AttackDefenseTreeMultiAgentTimeEnv(env_file, render_mode="human")
    ...
    for agent in env.agent_iter():
        ...
        if not available_actions:
            ...
            for action_id in available_actions:
                ...
                print(f"  [{action_id}] {action_spec['name']} (cost: {action_spec.get('cost', 0)}, time: {action_spec.get('time', 0)})")
